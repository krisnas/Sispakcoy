        ...
        <div class="row justify-content-center">
            <div class="col-lg-10 text-left">
                ...
                <div class="row g-0">
                    ...
                    <div class="col-sm-8 fw-normal fs-1 py-3">Masukkan Gejala</div>
                </div>
                <hr>
                <form class="form-horizontal" data-toggle="validator" role="form" method="post" action="admin_input_gejala.php">
                    <div class="form-group has-feedback">
                        <p><b>Masukkan ID Gejala:</b></p>
                    ...
                    <div class="form-group has-feedback">
                        <p><b>Masukkan Gejala Penyakit:</b></p>
                        <div class="col-md-12">
