            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="section-title text-center">
                        <h2 class="text-center fw-normal fs-1">Tentang Kami</h2>
                        <hr>
                    </div>
                </div>
            </div>
            <div class="row text-center">
                <div class="col-6 col-sm-3 mb-4 shadow-sm">
                    <div class="service-item p-4 bg-white">
                        <div class="icon my-3 text-success fs-1">
                            <i class="fas fa-user fa-lg"></i>
                        </div>
                        <h3 class="fs-5 py-2 fw-bold">Krisna Subarkah</h3>
                        <p class="text-muted fs-5">18102271</p>
                        <div class="col-lg-12 text-center">
                            <ul class="list-unstylyed list-inline">
                                ...
                                <li class="list-inline-item">
                                    <a href="https://wa.me/6281234567890" class=" btn-floating btn-lg text-dark"><i class="fab fa-whatsapp"></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-6 col-sm-3 mb-4 shadow-sm">
                    <div class="service-item p-4 bg-white">
                        ...
                        <h3 class="fs-5 py-2 fw-bold">Muhammad Jauhar Alfy T.</h3>
                        <p class="text-muted fs-5">18102276</p>
                        <div class="col-lg-12 text-center">
                            <ul class="list-unstylyed list-inline">
                                <li class="list-inline-item">
                                    <a href="https://www.facebook.com/" class="btn-floating btn-lg text-dark"><i class="fab fa-facebook-f"></i></a>
                ...
                <div class="col-6 col-sm-3 mb-4 shadow-sm">
                    <div class="service-item p-4 bg-white">
                        ...
                        <h3 class="fs-5 py-2 fw-bold">Nadila Dwiyanti</h3>
                        <p class="text-muted fs-5">18102278</p>
                        <div class="col-lg-12 text-center">
                            <ul class="list-unstylyed list-inline">
                                <li class="list-inline-item">
                                    <a href="https://www.facebook.com/" class="btn-floating btn-lg text-dark"><i class="fab fa-facebook-f"></i></a>
                ...
                <div class="col-6 col-sm-3 mb-4 shadow-sm">
                    <div class="service-item p-4 bg-white">
                        ...
                        <h3 class="fs-5 py-2 fw-bold">Rochmat Indrajaya</h3>
                        <p class="text-muted fs-5">18102284</p>
                        <div class="col-lg-12 text-center">
                            <ul class="list-unstylyed list-inline">
                                <li class="list-inline-item">
                                    <a href="https://www.facebook.com/" class="btn-floating btn-lg text-dark"><i class="fab fa-facebook-f"></i></a>
